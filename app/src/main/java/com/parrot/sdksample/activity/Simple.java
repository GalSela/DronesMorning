...
public class Simple extends AppCompatActivity {
    ...
    private void initIHM() {
        ...
        findViewById(R.id.btnEmrg).setOnClickListener(new View.OnClickListener() {
    ...
    /*private final BebopDrone.Listener mBebopListener = new BebopDrone.Listener() {
        ...
        public void onMatchingMediasFound(int nbMedias) {
            ...
            if (nbMedias > 0) {
                mDownloadProgressDialog = new ProgressDialog(Simple.this, R.style.AppCompatAlertDialogStyle);
